...
const GROUPS: { name: string; hint: string; keys: string[] }[] = [
  ...
  { name: "模型路由", hint: "按等级给会话指定主 / 备用模型；用户也能用「/切换模型」在等级圈定的名单里自助换", keys: ["model_route_enabled", "model_route_failure_threshold", "model_route_circuit_sec", "model_switch_enabled", "model_switch_timeout_sec", "model_card_theme", "model_card_font"] },
